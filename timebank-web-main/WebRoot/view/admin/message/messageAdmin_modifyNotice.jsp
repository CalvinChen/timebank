...
<div id="wrapper">
	...
	<div id="page-bgtop">
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">修改通知</a></h2>
				<div class="entry">
					<form action="MessageAdmin_submitModifyNotice" method="post">
						<fieldset>
							<input type="hidden" name="one.messageId" value="${one.messageId}"/>
								...
								<div class="oneRow clear">
									<div class="rowLeft"></div>
									<div class="rowRight"><input type="submit" value="嗯，修改完毕！" class="button"/></div>
								</div>
						</fieldset>
					</form>
					<hr/>
