...
<div id="wrapper">
	...
	<div id="page-bgtop">
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">时间提取向导</a></h2>
				<p class="meta">
					<a id="tip" href="#">
						本向导可帮助你向时间银行提取出更为宝贵有效的时间。
						<span id="tip_info">
							温馨提示：向时间银行提取出一枚时间币，意即在时间银行的中介作用下，接受了别人一次有效的帮助！
						</span>
					</a>
				</p>
				<div class="entry">
					<div id="loginForm">
						<form method="post" action="Withdraw_selectSubmit">
							<fieldset>
								<div id="fieldset">
									...
									<div class="oneRow clear">
										<div class="rowLeft"></div>
										<div class="rowRight"><h2>我需要别人帮助！那么我可以……</h2></div>
									</div>
									<hr />
									<div class="oneRow clear">
										<div class="rowLeft">
