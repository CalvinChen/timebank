							...
							<ul>
									...
									<div class="rowRight">
										<li>
											<div id="hh2" style="display: none;">
												时间预提取是指您已经向银行提交了您的寻求帮助时间，
												但只有等到您通过时间银行在这段时间得到别人的帮助了，才算是提取了时间。
												<hr />
												<span class="warn">时间预提取不会减少时间币，只有真正提取了（即切实接受了帮助）才减少时间币。</span>
											</div>
											<h2 id="message" class="supertips" title="预提取？" rel="#hh2">
												恭喜您，此时间预提取成功！
												<img src="/TimeBank/CSS/images/tip.png" alt="" class="pictureTip"/>
											</h2>
											接下来您的此条提取记录将会对时间银行所有会员展示，<br />
											如果有符合您寻求帮助要求的帮助者申请帮助您，<br />
								...
								<div class="oneRow">
									...
									<div class="rowRight">
										<li>
											您现在可以选择查看：<br />
											<a href="/TimeBank/withdraw/Withdraw_viewList">我所有提取的时间清单；</a><br />
