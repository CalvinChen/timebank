...
<div id="wrapper">
	...
	<div id="page-bgtop">
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">提取时间</a></h2>
				<p class="meta">
					<a id="tip" href="#">
				...
				<div class="entry">
					<form action="Withdraw_submit" method="post">
						<fieldset>
							...
							<div class="oneRow clear">
								<div class="rowLeft emphasized"><label for="gettedTime">1，求助时间</label></div>
								<div class="rowRight">
									...
									<select name="one.theTime">
										...
										<option value="13">双方协商</option>
									</select>
								</div>
							</div>
							<hr/>
							<div class="oneRow clear">
								<div class="rowLeft emphasized">2，求助区域</div>
								<div class="rowRight">
									<span class="emphasized">
										<span class="radio">
											<input id="L1-1" type="radio" name="one.zoneWithdraw" value="1" checked="checked"/>
											<label for="L1-1">启林南</label>
										</span>
										<span  class="radio">
											<input id="L1-2" type="radio" name="one.zoneWithdraw" value="2"/>
											<label for="L1-2">启林北</label>
										</span>
										<span  class="radio">
											<input id="L1-4" type="radio" name="one.zoneWithdraw" value="3"/>
											<label for="L1-4">五山</label>
										</span>
										<span  class="radio">
											<input id="L1-3" type="radio" name="one.zoneWithdraw" value="4"/>
											<label for="L1-3">华山</label>
										</span>
										<br /><br />
										<span  class="radio">
											<input id="L1-5" type="radio" name="one.zoneWithdraw" value="5"/>
							...
							<hr />
							<div class="oneRow clear">
								<div class="rowLeft emphasized">3，求助范围</div>
								<div class="rowRight">
									<span class="emphasized">
										<span  class="radio">
											<input id="L2-1" type="radio" name="one.rangeWithdraw" value="1" checked="checked"/>
											<label for="L2-1">知识技能类</label>
										</span>
										<span  class="radio">
											<input id="L2-2" type="radio" name="one.rangeWithdraw" value="2"/>
											<label for="L2-2">休闲娱乐类</label>
										</span>
										<span  class="radio">
											<input id="L2-3" type="radio" name="one.rangeWithdraw" value="3"/>
											<label for="L2-3">体育运动类</label>
										</span>
										<span  class="radio">
											<input id="L2-4" type="radio" name="one.rangeWithdraw" value="4"/>
											<label for="L2-4">劳动修缮类</label>
										</span>
										<br /><br />
										<span  class="radio">
											<input id="L2-5" type="radio" name="one.rangeWithdraw" value="5"/>
							...
							<div id="text1" style="display: none;">
								<span class="emphasized">为了让其他人理解你所需要帮助的内容，请尽量详细说明，例如：</span>
								<hr />
								<span class="tips">
									“我的电脑最近变得好慢，好像是装太多软件了，一开机要等很久。
									但是我不怎么会电脑，希望有个比较懂电脑的人帮我清理清理电脑，
									先说明，我是女生，电脑是台式机，所以可能对方是女生会比较方便。
									如果是男生的话，我也可以把电脑搬下来吧！先谢谢了！”
								</span>
							</div>
							...
							<div class="oneRow clear">
								...
								<div class="rowRight">
									...
									<span class="tips">(点击此按钮之后其他人将可以看到您此条求助信息。)</span>
								</div>
							</div>
						</fieldset>
					</form>
