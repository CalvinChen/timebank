				...
				<div class="entry">
					<fieldset>
							<table id="topTable"> 
								...
								<tbody>
								<c:if test="${!empty topList || !empty top2List}">
									<div>
															...
															<td>
																<div class="cellRecord">
																	<div>
																		...
																		<br />
																		<a href="Deposit_viewOne?withdrawId=${one.withdrawId}#flag">
																			${one.description}
																		</a>
																	</div>
								...
								<tbody>
									<c:choose>
										<c:when test="${empty recordList}">
											<tr>
												<td colspan="5">
													好像大家暂时没有什么需要帮助的事情哦，或者<a href="/TimeBank/deposit/Deposit_selectSubmit?select=2">直接去存储我的一段时间，等其他人来找我帮忙吧</a>！
												</td>
											</tr>
										</c:when>
										<c:otherwise>
