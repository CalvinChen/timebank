...
public interface DepositDao {
	 ...
	 * @return 欲取得的存储记录
	 */
	public abstract BankCoreBusiness readOneById(int depositId);
	 ...
	 * @return 更新的结果
	 */
	public abstract String updateOneById(BankCoreBusiness one);
	 ...
	 * @return 该用户所有的存储记录表
	 */
	public abstract ArrayList<BankCoreBusiness> readSomeByUserId(int userId);
	 ...
	 */
	public abstract ArrayList<BankCoreBusiness> readSomeByStatus(int status);
	 ...
	 * @return 数据库中所有该类型的存储记录
	 */
	public abstract ArrayList<BankCoreBusiness> readSomeByStatusLimit(int status,
			int page);
	 ...
	 * @return 结果
	 */
	public abstract String createOne(BankCoreBusiness one);
	 ...
	 * @return
	 */
	public abstract ArrayList<BankCoreBusiness> getDisplayDepositsByStatus(
	 ...
	 * @return
	 */
	public abstract ArrayList<BankCoreBusiness> getDisplayDepositsByStatusLimit(
