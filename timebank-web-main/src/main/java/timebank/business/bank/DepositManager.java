...
//	@Resource
	 ...
	 * @return 该用户所有的存储记录表
	 */
	public ArrayList<BankCoreBusiness> getOnesDeposit(int userId) {
		ArrayList<BankCoreBusiness> result = depositDao.readSomeByUserId(userId);
		return result;
	}
	 ...
	 * @return 欲取得的存储记录
	 */
	public BankCoreBusiness getOneDepositByDepositId(int depositId) {
		BankCoreBusiness one = depositDao.readOneById(depositId);
		return one;
	}
	 ...
	 */
	public ArrayList<BankCoreBusiness> getDepositsByStatusLimit(int status, int p) {
		ArrayList<BankCoreBusiness> result = depositDao.readSomeByStatusLimit(status, p);
		return result;
	}
	/**
	 * 获得所有对应状态的存储记录
	 ...
	 * @return 数据库中所有对应状态的存储记录
	 */
	public ArrayList<BankCoreBusiness> getDepositsByStatus(int status, int p) {
		ArrayList<BankCoreBusiness> result = depositDao.readSomeByStatusLimit(status, p);
		return result;
	}
	 ...
	 * @return 结果
	 */
	public String addOneDeposit(BankCoreBusiness one, int userId) {
		//增加记录
...
//	}
	 ...
	 * @return
	 */
	public ArrayList<BankCoreBusiness> getTopAndDetailedDepositsByStatus(int status) {
		return depositDao.getDisplayDepositsByStatus(status, Values.YES, Values.YES);
	}
	public ArrayList<BankCoreBusiness> getTopAndNotDetailedDepositsByStatus(int status) {
	 ...
	 * @return
	 */
	public ArrayList<BankCoreBusiness> getNormalDepositsByStatusLimit(
			int status, int p) {
