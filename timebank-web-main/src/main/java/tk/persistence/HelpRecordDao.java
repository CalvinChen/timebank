...
public interface HelpRecordDao {
	 ...
	 * @return 该用户所有的互助记录表
	 */
	public abstract ArrayList<HelpRecord> readSomeByUserId(int userId);
	 ...
	 * @return 该条互助记录
	 */
	public abstract HelpRecord readOne(int helpRecordId);
	 ...
	 * @return 增加的结果
	 */
	public abstract int createOne(HelpRecord one);
	 ...
	 * @return 所有符合要求的互助记录
	 */
	public abstract ArrayList<HelpRecord> readSomeByStatus(int status, int page);
	 ...
	 * @return 该条互助记录的所有信息
	 */
	public abstract HelpRecord readOneById(int helpRecordId);
