...
public class DepositAction {
	...
	//--------------viewList----------------------------------------
	private ArrayList<SideRecord> myDepositTime;
	public ArrayList<SideRecord> getMyDepositTime() {
		return myDepositTime;
	}
	public void setMyDepositTime(ArrayList<SideRecord> myDepositTime) {
	...
	public SideRecord getOne() {
		return one;
	}
	public void setOne(SideRecord one) {
		this.one = one;
	}
	...
	public String require(){
		...
		int toHelpUserId = ((User)ActionContext.getContext().getSession().get("userLogined")).getId();
...
//		newRecord.setLinkWithdrawId(one.getBankCoreBusinessId());
	...
	public String submit(){
		...
		if(depositManager.addOneDeposit(one, user.getId()).equals(Values.SUCCESS)){
			return "succ";
		}else{
