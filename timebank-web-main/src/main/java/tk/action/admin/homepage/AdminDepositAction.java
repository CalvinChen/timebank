...
public class AdminDepositAction {
	...
	private SideRecord deposit;
	private int depositId;
	private String message;
	private int page;
	private ArrayList<SideRecord> seekedDepositList;
	private int count;
	private int pages;
	private ArrayList<SideRecord> unmatchedDepositList;
	private ArrayList<SideRecord> expiredDepositList;
	...
	public ArrayList<SideRecord> getSeekedDepositList() {
		return seekedDepositList;
	}

	public void setSeekedDepositList(ArrayList<SideRecord> seekedDepositList) {
	...
	public ArrayList<SideRecord> getUnmatchedDepositList() {
		return unmatchedDepositList;
	}

	public void setUnmatchedDepositList(
			ArrayList<SideRecord> unmatchedDepositList) {
		this.unmatchedDepositList = unmatchedDepositList;
	}

	public ArrayList<SideRecord> getExpiredDepositList() {
		return expiredDepositList;
	}

	public void setExpiredDepositList(ArrayList<SideRecord> expiredDepositList) {
	...
	public SideRecord getDeposit() {
		return deposit;
	}

	public void setDeposit(SideRecord deposit) {
...
//			message = "修改成功！";
//		}
		deposit = depositManager.getOneDepositByDepositId(deposit.getId());
		return "view";
	}
}
