package tk.action.admin.homepage;
...
public class AdminHelpRecordAction {
	...
	private int count;
	private int pages;
	private ArrayList<HelpRecord> successRecordList;
	private ArrayList<HelpRecord> failureRecordList;
	private ArrayList<HelpRecord> verifiedFailureRecordList;
	private ArrayList<HelpRecord> toFeedbackRecordList;
	private ArrayList<HelpRecord> unhandleRecordList;
	...
	public ArrayList<HelpRecord> getSuccessRecordList() {
		return successRecordList;
	}

	public void setSuccessRecordList(ArrayList<HelpRecord> successRecordList) {
		this.successRecordList = successRecordList;
	}

	public ArrayList<HelpRecord> getFailureRecordList() {
		return failureRecordList;
	}

	public void setFailureRecordList(ArrayList<HelpRecord> failureRecordList) {
		this.failureRecordList = failureRecordList;
	}

	public ArrayList<HelpRecord> getVerifiedFailureRecordList() {
		return verifiedFailureRecordList;
	}

	public void setVerifiedFailureRecordList(
			ArrayList<HelpRecord> verifiedFailureRecordList) {
		this.verifiedFailureRecordList = verifiedFailureRecordList;
	}

	public ArrayList<HelpRecord> getToFeedbackRecordList() {
		return toFeedbackRecordList;
	}

	public void setToFeedbackRecordList(ArrayList<HelpRecord> toFeedbackRecordList) {
		this.toFeedbackRecordList = toFeedbackRecordList;
	}

	public ArrayList<HelpRecord> getUnhandleRecordList() {
		return unhandleRecordList;
	}

	public void setUnhandleRecordList(ArrayList<HelpRecord> unhandleRecordList) {
	...
	public String handle(){
		String adminName = ((Admin)ActionContext.getContext().getSession().get("adminLogined")).getLoginName();
