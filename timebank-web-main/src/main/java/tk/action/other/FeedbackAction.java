...
import tk.business.other.FeedbackManager;
...
public class FeedbackAction {
	...
	public String viewOne(){
		getUserFromUserLogined();
		feedback = feedbackManager.getFeedbackRecordById(getFeedbackId, user.getId());
		return "viewOne";
	}
...
//		}
	...
	private void getUserFromUserLogined() {
		...
		user = userManager.getUserInfo(user.getId());
